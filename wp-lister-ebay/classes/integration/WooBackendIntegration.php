...
class WPL_WooBackendIntegration {
	...
	function wpl_woocommerce_edit_shop_order_columns($columns){
		## BEGIN PRO ##
		// $columns['wpl_order_src'] = '<img src="'.WPLE_PLUGIN_URL.'/img/hammer-dark-16x16.png" title="'.__( 'Placed on eBay', 'wp-lister-for-ebay' ).'" />';
        ...
        foreach ($columns as $key => $value) {
            ...
            if($key == 'order_status')
				...
				$new_columns['wpl_order_src'] = '<img src="'.WPLE_PLUGIN_URL.'img/cart-32x32.png" style="width:16px;vertical-align:top;padding:0;" class="tips" data-tip="'.__( 'Source', 'wp-lister-for-ebay' ).'" />';
        }
        return $new_columns;
