...
update_option( 'wple_last_active_license_key', '****************' );
update_option( 'wple_last_active_license_email', 'temp@wplab.com' );
update_option( 'wple_activation_email', 'temp@wplab.com' );
update_option( 'wple_api_key', '****************' );
update_option( 'wple_activated_key', 1 );
define('WPLE_PLUGIN_VERSION', '3.7.3' );
...
## BEGIN PRO ##
define('WPLE_IS_LITE_VERSION', false );
require_once( WPLE_PLUGIN_PATH . '/includes/WPLE_CustomUpdater_v2.php' );
## END PRO ##
...
class WPL_WPLister extends WPL_BasePlugin {
	...
	public function onWpInit() {
		...
		if ( get_option( 'wplister_license_error', 0 ) ) {
			wple_show_message( __('The importing of eBay orders is currently suspended. Please check your WP-Lister license on <a href="https://wplab.com">wplab.com</a> or contact support for assistance.'),'error', ['dismissible' => false]);
		}
