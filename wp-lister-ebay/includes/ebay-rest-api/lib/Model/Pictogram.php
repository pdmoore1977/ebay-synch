 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Pictogram implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Pictogram';
     ...
     * Sets pictogram_id
     *
     * @param string $pictogram_id The identifier of the pictogram. For sample values, see <a href='/api-docs/sell/static/metadata/feature-regulatorhazmatcontainer.html#Pictogra'>Pictogram sample values</a>.
     *
     * @return $this
     */
     ...
     *
     * @param string $pictogram_description The description of the pictogram localized to the default language of the marketplace. For sample values, see <a href='/api-docs/sell/static/metadata/feature-regulatorhazmatcontainer.html#Pictogra'>Pictogram sample values</a>.
     *
     * @return $this
     */
